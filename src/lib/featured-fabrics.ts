...
export const featuredFabrics: FabricSuggestion[] = [
    {
        ...
        properties: ['Breathable', 'Durable', 'Natural'],
    },
    {
        fabricName: 'Emerald Green Velvet',
        description: 'Lush, decadent, and rich in color for a statement piece.',
        imageUrl: 'https://images.unsplash.com/photo-1600574044819-a634346517a9?q=80&w=800',
        properties: ['Luxurious', 'Soft', 'Vibrant'],
    },
    {
    ...
    },
    {
        ...
        description: 'Adds wonderful texture and warmth to any piece of furniture.',
